...
class AwsService(object):
    ...
    def service_regions(self):
        ...
        """
        return services.get_session().get_available_regions(service_name=self.service_name, partition_name="aws-us-gov")
    ...
    def assumed_role(self):
        ...
        if self._assumed_role is None:
            ...
            if re.match("^arn:aws-us-gov:iam::\\d{12}:role/", arn):
